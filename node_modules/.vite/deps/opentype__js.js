...
function addGlyphNamesAll(font) {
	...
	for (var i$1 = 0; i$1 < font.glyphs.length; i$1 += 1) {
		...
		if (font.cffEncoding) if (font.isCIDFont) glyph.name = "gid" + i$1;
...
GlyphSet.prototype.get = function(index) {
	if (this.glyphs[index] === void 0) {
		...
		if (this.font.cffEncoding) if (this.font.isCIDFont) glyph.name = "gid" + index;
...
function loadFromFile(path, callback) {
	require_browser_external_fs().readFile(path, function(err, buffer) {
...
function loadSync(url, opt) {
	return parseBuffer(nodeBufferToArrayBuffer(require_browser_external_fs().readFileSync(url)), opt);
}
...
//#endregion
export { BoundingBox, Font, Glyph, Path, parse as _parse, opentype as default, load, loadSync, parseBuffer as parse };
